        ...
        <div className="footer d-flex justify-content-between ps-3 pt-4">
            ...
            <div className="datosEmpresa text-white d-flex">
                <ul className=" ">
                    ...
                    <img src="https://icongr.am/fontawesome/map-marker.svg?size=30&color=0d41fd" alt="Ubicacion" /> 
                        <li className="ps-2">España 1450</li></div>
                    <div className="d-flex mb-4">
                    <img src="https://icongr.am/fontawesome/whatsapp.svg?size=30&color=00f51d" alt="whatapps" /> 
                        <li className="ps-2">3815401511</li>
                    </div>
                    <div className="d-flex ">
                    <img src="https://icongr.am/fontawesome/clock-o.svg?size=30&color=ffffff" alt="clock" /> 
            ...
            <div className="d-flex flex-column pe-3">
                ...
                <Nav.Link ><img className="efecto-footer"src="https://icongr.am/devicon/facebook-original.svg?size=40&color=currentColor" alt="facebook" /></Nav.Link> 
                <Nav.Link><img className="efecto-footer" src="https://icongr.am/devicon/twitter-original.svg?size=40&color=currentColor" alt="twitter" /></Nav.Link> 
                <Nav.Link><img className="efecto-footer" src="https://icongr.am/devicon/facebook-original.svg?size=40&color=currentColor" alt="instagram" /></Nav.Link> 
                </div>
            </div>
        </div>
    )
