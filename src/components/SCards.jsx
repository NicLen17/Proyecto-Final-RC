    ...
    return (
        <div>
            ...
            <div>
                ...
                <Card className="cards">
                    <Card.Img className="cardimg" variant="top" src="https://images.samsung.com/is/image/samsung/p6pim/pe/sm-g780fzglltp/gallery/pe-galaxy-s20-fe-g780-357343-sm-g780fzglltp-thumb-327368871?$LazyLoad_Home_IMG$" />
                    <Card.Body className="cardfooter">
                        <p>$$$</p>
                        <p>---</p>
                    </Card.Body>
